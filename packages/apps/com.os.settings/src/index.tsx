...
export const Settings: React.FC<SettingsProps> = () => {
  ...
  // 更新相关状态
  const [autoUpdateEnabled, setAutoUpdateEnabled] = useState(() => updateManager.getConfig().autoUpdate);
  const [updateStatus, setUpdateStatus] = useState<UpdateStatus>(() => updateManager.getStatus());
    ...
    <div className="settings-section">
      ...
      <div className="settings-group">
        ...
        <p className="settings-hint" style={{ marginTop: '4px', fontSize: '12px' }}>
          {t('settings.buildTime')}: {new Date(__BUILD_TIME__).toLocaleString()}
        </p>
    ...
    <div className="settings-section">
      ...
      <div className="about-info">
        ...
        <div className="info-row">
          ...
          <span className="info-value">WebOS Kernel v1.0</span>
        </div>
        <div className="info-row">
