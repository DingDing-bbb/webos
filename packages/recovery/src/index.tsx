...
import type { BootError, BootStatus } from '@webos/bootloader';
import { bootloader } from '@webos/bootloader';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '32px', fontWeight: 'bold' }}>{errorStats.total}</div>
            <div style={{ fontSize: '12px', color: '#888' }}>Total Errors</div>
          </div>
          {errorStats.syntax > 0 && (
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '24px', color: '#ff9800' }}>{errorStats.syntax}</div>
              <div style={{ fontSize: '12px', color: '#888' }}>Syntax</div>
            </div>
          )}
          {errorStats.module > 0 && (
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '24px', color: '#e91e63' }}>{errorStats.module}</div>
        ...
        >
          {status.errors.map((error, index) => (
            <div
              ...
              style={{
                borderBottom:
                  index < status.errors.length - 1 ? '1px solid rgba(255,255,255,0.1)' : 'none',
                padding: '10px 0',
              }}
            >
              <div
      ...
      >
        ...
        <div
          style={{
            background: canReset ? 'rgba(76, 175, 80, 0.1)' : 'rgba(255, 255, 255, 0.05)',
            border: canReset
      ...
      >
        ...
        <div style={{ color: '#888', fontFamily: 'monospace' }}>
          ...
          <div>
            <span style={{ color: '#f44336' }}>webosResetSystem()</span> - Reset system (requires
            plugin)
          </div>
        </div>
      </div>
