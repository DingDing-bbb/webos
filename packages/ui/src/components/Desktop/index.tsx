 ...
 * @example
 * ```tsx
 * import { Desktop } from '@webos/ui/components/Desktop';
 *
 * <Desktop
 *   apps={[
...
export const Desktop: React.FC<DesktopProps> = ({
  ...
  const desktopMenuItems: ContextMenuItem[] = [
    {
      id: 'view',
      label: window.webos?.t('contextMenu.view') || 'View',
      icon: <ViewIcon />,
      submenu: [
        {
          id: 'large-icons',
          label: window.webos?.t('contextMenu.largeIcons') || 'Large icons',
          onClick: () => console.log('Large icons'),
        },
        {
          id: 'small-icons',
          label: window.webos?.t('contextMenu.smallIcons') || 'Small icons',
          onClick: () => console.log('Small icons'),
        },
        {
          id: 'list',
          label: window.webos?.t('contextMenu.list') || 'List',
          onClick: () => console.log('List'),
        },
        {
          id: 'details',
          label: window.webos?.t('contextMenu.details') || 'Details',
          onClick: () => console.log('Details'),
        },
        {
          id: 'tiles',
          label: window.webos?.t('contextMenu.tiles') || 'Tiles',
          onClick: () => console.log('Tiles'),
        },
        {
          id: 'content',
          label: window.webos?.t('contextMenu.content') || 'Content',
    ...
    {
      id: 'sort-by',
      label: window.webos?.t('contextMenu.sortBy') || 'Sort by',
      icon: <SortIcon />,
      submenu: [
        {
          id: 'name',
          label: window.webos?.t('contextMenu.name') || 'Name',
          onClick: () => console.log('Sort by name'),
        },
        {
          id: 'date',
          label: window.webos?.t('contextMenu.modifiedDate') || 'Modified date',
          onClick: () => console.log('Sort by date'),
        },
        {
          id: 'type',
          label: window.webos?.t('contextMenu.type') || 'Type',
          onClick: () => console.log('Sort by type'),
        },
        {
          id: 'size',
          label: window.webos?.t('contextMenu.size') || 'Size',
          onClick: () => console.log('Sort by size'),
        },
        {
          id: 'ascending',
          label: window.webos?.t('contextMenu.ascending') || 'Ascending',
          onClick: () => console.log('Ascending'),
        },
        {
          id: 'descending',
          label: window.webos?.t('contextMenu.descending') || 'Descending',
          onClick: () => console.log('Descending'),
        },
        { divider: true, id: 'divider-sort', label: '' },
        {
          id: 'more',
          label: window.webos?.t('contextMenu.more') || 'More...',
    ...
    {
      id: 'refresh',
      label: window.webos?.t('contextMenu.refresh') || 'Refresh',
      shortcut: 'F5',
    ...
    {
      id: 'new',
      label: window.webos?.t('contextMenu.new') || 'New',
      icon: <NewIcon />,
      submenu: [
        {
          id: 'new-folder',
          label: window.webos?.t('contextMenu.folder') || 'Folder',
          onClick: () => console.log('New folder'),
        },
        {
          id: 'new-shortcut',
          label: window.webos?.t('contextMenu.shortcut') || 'Shortcut',
          onClick: () => console.log('New shortcut'),
        },
        { divider: true, id: 'divider-new', label: '' },
        {
          id: 'new-text',
          label: window.webos?.t('contextMenu.textDocument') || 'Text Document',
          onClick: () => console.log('New text'),
        },
        {
          id: 'new-zip',
          label: window.webos?.t('contextMenu.compressedFolder') || 'Compressed Folder',
          onClick: () => console.log('New zip'),
        },
        {
          id: 'new-image',
          label: window.webos?.t('contextMenu.image') || 'Image',
    ...
    {
      id: 'display-settings',
      label: window.webos?.t('contextMenu.displaySettings') || 'Display settings',
      onClick: () => window.webos?.window.open('com.os.settings'),
    },
    {
      id: 'personalize',
      label: window.webos?.t('contextMenu.personalize') || 'Personalize',
      icon: <PaletteIcon />,
      submenu: [
        {
          id: 'theme',
          label: window.webos?.t('contextMenu.theme') || 'Theme',
          onClick: () => console.log('Theme'),
        },
        {
          id: 'background',
          label: window.webos?.t('contextMenu.background') || 'Background',
          onClick: () => console.log('Background'),
        },
        {
          id: 'colors',
          label: window.webos?.t('contextMenu.colors') || 'Colors',
          onClick: () => console.log('Colors'),
        },
        {
          id: 'lockscreen',
          label: window.webos?.t('contextMenu.lockScreen') || 'Lock screen',
          onClick: () => console.log('Lock screen'),
        },
        {
          id: 'fonts',
          label: window.webos?.t('contextMenu.fonts') || 'Fonts',
          onClick: () => console.log('Fonts'),
        },
        {
          id: 'taskbar',
          label: window.webos?.t('contextMenu.taskbar') || 'Taskbar',
    ...
    {
      id: 'terminal',
      label: window.webos?.t('contextMenu.openTerminal') || 'Open in Terminal',
      shortcut: 'Ctrl+Alt+T',
  ...
  const getIconMenuItems = useCallback(
    (iconId: string): ContextMenuItem[] => {
      ...
      return [
        {
          id: 'open',
          label: window.webos?.t('contextMenu.open') || 'Open',
          icon: <OpenIcon />,
          onClick: () => icon?.onOpen?.(),
        },
        {
          id: 'run-as',
          label: window.webos?.t('contextMenu.runAs') || 'Run as',
          icon: <RunAsIcon />,
          onClick: () => icon?.onOpen?.(),
        },
        ...
        {
          id: 'cut',
          label: window.webos?.t('contextMenu.cut') || 'Cut',
          shortcut: 'Ctrl+X',
          icon: <CutIcon />,
        ...
        {
          id: 'copy',
          label: window.webos?.t('contextMenu.copy') || 'Copy',
          shortcut: 'Ctrl+C',
          icon: <CopyIcon />,
        ...
        {
          id: 'create-shortcut',
          label: window.webos?.t('contextMenu.createShortcut') || 'Create shortcut',
          onClick: () => console.log('Create shortcut:', iconId),
        },
        {
          id: 'delete',
          label: window.webos?.t('contextMenu.delete') || 'Delete',
          icon: <DeleteIcon />,
          onClick: () => console.log('Delete:', iconId),
        },
        {
          id: 'rename',
          label: window.webos?.t('contextMenu.rename') || 'Rename',
          onClick: () => console.log('Rename:', iconId),
        },
        { id: 'divider-icon-2', label: '', divider: true },
        {
          id: 'pin',
          label: window.webos?.t('contextMenu.pinToTaskbar') || 'Pin to taskbar',
          icon: <PinIcon />,
        ...
        {
          id: 'properties',
          label: window.webos?.t('contextMenu.properties') || 'Properties',
          icon: <InfoIcon />,
