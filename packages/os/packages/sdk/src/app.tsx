/**
 * @fileoverview WebOS SDK - Application Helpers
 * @module @webos/sdk/app
 *
 * 应用创建和注册工具
 */
 ...
 * @example
 * ```typescript
 * import { registerApp } from '@webos/sdk/app';
 * import MyApp from './MyApp';
 * import MyAppIcon from './icon';
 *
 * registerApp({
